...
CREATE TABLE `game` (
  ...
  `given_letters` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `score` int(11) DEFAULT NULL,
  `difficulty` int(11) DEFAULT NULL,
  `fails` int(11) DEFAULT NULL,
  PRIMARY KEY (`game_id`),
  KEY `game_uid` (`user_id`),
  KEY `game_wid` (`word_id`)
...
INSERT INTO `player` VALUES (1,'anonymous','',0),(2,'admin','admin',1);
...
-- Dump completed on 2016-01-23 15:13:39
